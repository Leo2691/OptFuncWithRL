...
"""
experiment_name = '0_RL_Rosenbrock_test' # '0_RL_Rastrigin_test' / '0_RL_Rosenbrock_test'
...
hp_sets = [
    {
        ...
        'type_of_surf'  : 'Rosenbrock', # 'Rastrigin' / 'Rosenbrock'

        'num_agents'    : 1,
        'n_values'      : 5, #100
        'range_values'  : np.arange(-2, 2, 0.2).tolist(), # np.arange(-12, 13, 0.2).tolist()
